...
<div class="d-flex" style="min-height: 100vh; background: linear-gradient(120deg, #f6f8fd, #e3efff);">
  ...
  <div class="flex-grow-1 p-4" style="background: #E2E9E8;">
    <div class="d-flex justify-content-between align-items-center mb-4">
      <h3 class="fw-bold" style="color:#436C5D;">Volunteer Status</h3>
    </div>
    <div class="row justify-content-center">
      <div class="col-md-7">
        <div class="card shadow-sm mb-4">
          <div class="card-header bg-secondary text-white">Volunteer Application Status</div>
          <div class="card-body">
            <p>Status: <b><?= htmlspecialchars($volunteerStatus ?? 'Not Applied') ?></b></p>
          </div>
        </div>
      </div>
    </div>
